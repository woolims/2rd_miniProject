...
<div id="box">
	...
	<div>
		<input type="button" id="buy_list" name="buy_list" value="구매내역">
		<input type="button" id="sell_list" name="sell_list" value="판매내역">
	</div>
	<div class="auction_div">
		<c:forEach var="vo" items="${ list }">
			<div class="col-sm-2 product_auc">
				...
				<br>
				<p style="text-align: left; margin: 0;">종료된 경매</p>
